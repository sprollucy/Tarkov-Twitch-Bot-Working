...
namespace UiBot
{
    internal class BitCommands
    {
        ...
        public BitCommands(TwitchClient client, string channelId)
        {
            this.client = client;
        ...
        //Chat Commands
        public async void HandleCommand(object sender, OnChatCommandReceivedArgs e)
        {
